  ...
  $.extend(SurveyorAjax, {
    ...
    prototype: {
      ...
      fieldsetData: function (element) {
        ...
        var parents = element.parents('fieldset[id^="q_"],tr[id^="q_"]');
        // console.log('   parents: ', parents);
        var found = parents.find("input, select, textarea");
        // console.log('   found: ', found);
        var found_added = found.add($("form#survey_form input[name='authenticity_token']"));
        // console.log('   found_added: ', found_added);
        var serialized = found_added.serialize();
